...
export function StatusBadge({ status }: { status: string }) {
  ...
  return (
    <div className={cn("inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider", config.color, config.bgColor)}>
      <Icon size={12} />
      {config.label}
    </div>
  );
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          {/* Quick Actions Card */}
          <Link href="/apply" className="block group relative overflow-hidden rounded-2xl bg-blue-600 text-white p-6 shadow-xl shadow-blue-600/20 hover:shadow-2xl hover:shadow-blue-600/30 transition-all">
